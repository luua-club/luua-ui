...
function AnalyticsCard({ metric }: { metric: IAnalyticsMetric }) {
  ...
  return (
    <Card className="flex min-w-48 flex-1 flex-col gap-1 rounded-lg border p-4 shadow-none">
...
function AnalyticsCardSkeleton() {
  return (
    <Card className="flex min-w-48 flex-1 flex-col gap-2 rounded-lg border p-4 shadow-none">
