...
function DraftCard({
  ...
  return (
    <Card
      ...
      className="bg-card/70 h-44 w-60 min-w-56 cursor-pointer gap-0 overflow-hidden rounded-md border p-0 shadow-none transition-shadow hover:shadow-md"
    >
...
function NewPostCard({ onClick }: { onClick: () => void }) {
  return (
    <Card
      onClick={onClick}
      className="bg-card/70 h-44 w-60 min-w-56 cursor-pointer gap-0 overflow-hidden rounded-md border-dashed p-0 shadow-none"
    >
...
function CreationLanding() {
  ...
  const { data, isPending } = useQuery({
    ...
    queryFn: () => draftsApi.getDrafts({ limit: 4, offset: 0, sort: 'desc' }),
    staleTime: 30_000,
  })
  ...
  return (
    <div className="bg-accent/60 min-h-screen pt-8">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="scrollbar flex flex-nowrap gap-4 overflow-x-auto pb-2">
