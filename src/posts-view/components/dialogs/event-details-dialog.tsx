...
const STATUS_META = {
  Published: {
    ...
    icon: CheckCircle,
    className:
      'border-green-200 bg-green-50 text-green-700 dark:border-green-400/50 dark:bg-green-500/22 dark:text-green-200',
  },
  Scheduled: {
    label: 'Scheduled',
    icon: Clock,
    className:
      'border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-400/50 dark:bg-blue-500/22 dark:text-blue-200',
  },
  Queued: {
    label: 'Queued',
    icon: Loader,
    className:
      'border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-400/50 dark:bg-amber-500/22 dark:text-amber-200',
  },
  Failed: {
    label: 'Failed',
    icon: XCircle,
    className:
      'border-red-200 bg-red-50 text-red-700 dark:border-red-400/50 dark:bg-red-500/22 dark:text-red-200',
  },
} as const
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent
        ...
        side="bottom"
        sideOffset={8}
        className="bg-popover text-popover-foreground w-[360px] border p-0 shadow-xl sm:w-[420px]"
        onPointerDown={e => e.stopPropagation()}
        onMouseDown={e => e.stopPropagation()}
      ...
      >
        ...
        <div className="bg-muted/45 dark:bg-muted/25 max-h-[340px] space-y-3 overflow-auto border-b">
          {event.content ? (
            <div className="p-4">
              <Post
                id={event.id}
