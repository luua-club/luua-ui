...
function BillingAndCredits() {
  ...
  const cancelSubscriptionMutation = useMutation({
    ...
    onSuccess: () => {
      // Refresh subscription and user data after cancellation
  ...
  // --- Effects ---
  /**
   * Show cancellation option only if user has an active subscription
   */
  useEffect(() => {
    if (
  ...
  return (
    <>
      ...
      {/* Show cancel subscription option only for active subscriptions */}
