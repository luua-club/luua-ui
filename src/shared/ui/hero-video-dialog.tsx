      ...
      {children ? (
        ...
        <div className={cn('relative', className)}>
          <button
            ...
            className="group relative aspect-video cursor-pointer border-0 bg-transparent p-0"
      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex h-screen items-center justify-center bg-black/50 backdrop-blur-md"
          >
            <motion.div
              {...selectedAnimation}
